        ...
        <div class="row">
            <div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form method="POST" action="{{ url('pamong') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-body">
                                @if ($errors->any())
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            ...
                                            <input name="pamong_nama" required type="text" class="form-control m-input" placeholder="Nama Staff Desa" value="{{ old('pamong_nama') }}">
                                        </div>
                                        <div class="form-group">
                                            <label>Jabatan Staff Desa</label>
                                            <input name="jabatan" required type="text" class="form-control m-input" placeholder="Jabatan" value="{{ old('jabatan') }}">
                                        </div>
                                        <div class="form-group">
                                            <label>Nomor Induk Pegawai (NIP)</label>
                                            <input name="pamong_nip" type="text" class="form-control m-input" placeholder="NIP" value="{{ old('pamong_nip') }}">
                                        </div>
                                        <div class="form-group">
                                            <label>Nomor Induk Kependudukan (NIK)</label>
                                            <input name="pamong_nik" type="text" class="form-control m-input" placeholder="NIK" value="{{ old('pamong_nik') }}">
                                        </div>
                                        {{-- <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="password" type="password" class="form-control m-input" placeholder="Password" value="{{ old('username') }}">
                                        </div> --}}
                                    </div>
                                    <div class="col-md-3">
                                            <div class="form-group">
