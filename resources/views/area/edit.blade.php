    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="box">
          ...
          <form class="form-horizontal" action="/peta/area/{{ $data->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="box-body">
              <div class="row">
                    ...
                    <div class="col-lg-9">
                      <select name="tipe_area_id" class="form-control">
                        ...
                        @foreach ($types as $type)
                          <option value="{{ $type->id }}" {{ (old('tipe_area_id') ?: $data->tipe_area_id) == $type->id ? 'selected' : '' }}>{{ $type->name }}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
