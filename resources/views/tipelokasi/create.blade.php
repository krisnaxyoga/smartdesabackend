    ...
    <div class="row">
      <div class="col-lg-8 col-sm-12 col-xs-12">
        ...
        <div class="box">
          ...
          <form class="form-horizontal" action="/peta/tipelokasi" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-9">
                  <img src="/images/Dummy.jpg" height="33" id="icon" />
