...
<div class="content-main" id="content-main">
    <div class="padding" id="table-activities">
        <form action="{{route('detail-aset.store', $id)}}" method="POST">
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kode_register" value="{{$kode_register}}" class="form-control" readonly>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="form-group">
                                        ...
                                        <textarea name="keterangan" rows="5" class="form-control" style="resize:none"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
