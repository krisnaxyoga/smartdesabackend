  ...
  <div class="padding">
    <div class="row">
      <div class="col-lg-6">
        ...
        @endif
        <div class="box">
          <div class="box-header"><h3>Form Tipe Area</h3></div>
          <div class="box-divider m-0"></div>
          <form class="form-horizontal" action="/peta/tipearea/{{ $data->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="box-body">
