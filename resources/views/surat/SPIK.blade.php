...
@section('content')
    ...
    <table class="body" style="width: 100%; border-collapse: collapse" cellspacing="0" cellpadding="0">
        <tr>
            <td width="180" style="vertical-align: top; padding-left: 55px; padding-right : 8px">Nama Lengkap</td>
        ...
        <tr>
            <td style="vertical-align: top; padding-left: 55px; padding-right : 8px">Jenis Kelamin</td>
            <td width="25" style="vertical-align: top">: </td>
            <td style="vertical-align: top">{{ $data->penduduk->sex == 1 ? "Laki - Laki" : "Perempuan" }}</td>
        </tr>
        <tr>
            <td style="vertical-align: top; padding-left: 55px; padding-right : 8px">Alamat/ Tempat Tinggal</td>
            <td width="25" style="vertical-align: top">: </td>
        ...
        <tr>
            <td style="vertical-align: top; padding-left: 55px; padding-right : 8px">Keperluan</td>
            <td width="25" style="vertical-align: top">: </td>
            <td style="vertical-align: top">	Sebagai pengantar untuk mendapatkan Surat Izin Keramaian berupa {{ $data->jenis_acara }} mulai tanggal {{$data->konversiTgl($data->berlaku_dari)}} sampai dengan {{$data->konversiTgl($data->berlaku_sampai)}} dengan keperluan {{$data->keperluan}}</td>
        </tr>
       
    </table>
    <p style="text-align : justify">
        {{-- <span class="tab-space"></span>Bahwa yang tersebut namanya diatas, sepanjang pengetahuan dan penelitian kami hingga saat dikeluarkannya surat keterangan ini memang benar Keluarga yang KURANG MAMPU dan tidak memiliki penghasilan tetap. --}}
        <span class="tab-space"></span>Demikian surat pengantar ini kami buat agar dapat dipergunakan sebagaimana mestinya.
    </p>
@endsection