...
@section('content')
    ...
    <table class="body" style="width: 100%; border-collapse: collapse" cellspacing="0" cellpadding="0">
        <tr>
            <td width="150" style="vertical-align: top; padding-left: 55px; padding-right : 8px">Nama Lengkap</td>
            <td style="vertical-align: top" width="25">: </td>
            <td style="vertical-align: top">{{ $data->penduduk->nama }}</td>
        </tr>
        
        <tr>
            <td width="150" style="vertical-align: top; padding-left: 55px; padding-right : 8px">Kewarganegaraan</td>
            <td style="vertical-align: top" width="25">: </td>
            <td style="vertical-align: top">{{ $data->penduduk->kewarganegaraan->nama }}</td>
        </tr>
       
        <tr>
            <td width="150" style="vertical-align: top; padding-left: 55px; padding-right : 8px">Tempat dan Tgl. Lahir</td>
            <td style="vertical-align: top" width="25">: </td>
            <td style="vertical-align: top">{{ $data->penduduk->tempatlahir }}, {{ $data->penduduk->tanggal_lahir_format }}</td>
        </tr>
        <tr>
            <td width="150" style="vertical-align: top; padding-left: 55px; padding-right : 8px">Agama</td>
            <td style="vertical-align: top" width="25">: </td>
        ...
        <tr>
            <td width="150" style="vertical-align: top; padding-left: 55px; padding-right : 8px">Pekerjaan</td>
            <td style="vertical-align: top" width="25">: </td>
            <td style="vertical-align: top">{{ $data->penduduk->pekerjaan->nama }}</td>
        </tr>
        <tr>
            <td width="150" style="vertical-align: top; padding-left: 55px; padding-right : 8px">No KTP</td>
            <td style="vertical-align: top" width="25">: </td>
            <td style="vertical-align: top">{{ $data->penduduk->nik }}</td>
        </tr>
        <tr>
            <td width="150" style="vertical-align: top; padding-left: 55px; padding-right : 8px">No KK</td>
            <td style="vertical-align: top" width="25">: </td>
            <td style="vertical-align: top">{{ $data->penduduk->keluarga ? $data->penduduk->keluarga->no_kk : $data->penduduk->no_kk_sebelumnya }}</td>
        </tr>
        <tr>
            <td width="150" style="vertical-align: top; padding-left: 55px; padding-right : 8px">Alamat</td>
            <td style="vertical-align: top" width="25">: </td>
...
{{--        
        <tr>
            <td width="150" style="vertical-align: top; padding-left: 55px; padding-right : 8px">Keperluan</td>
            <td style="vertical-align: top" width="25">: </td>
    ...
    <p style="text-align : justify">
        <span class="tab-space"></span>Telah memenuhi syarat untuk mengurus / memperpanjang KTP
    </p>
    @endif
