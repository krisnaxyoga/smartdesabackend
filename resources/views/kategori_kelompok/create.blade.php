        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form method="POST" action="{{ route('kategori-kelompok.store') }}">
                            {{ csrf_field() }}
                            <div class="form-body">
                                @if ($errors->any())
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="kelompok" required type="text" class="form-control m-input col-5" placeholder="Nama Kelompok" value="{{ old('nama') }}">
                                </div>

                                <div class="form-group">
                                    <label>Keterangan</label>
                                    <textarea class="form-control col-5" name="deskripsi" rows="7" placeholder="Keterangan" >{{old('deskripsi')}}</textarea>
                                </div>
