    ...
    <div class="padding">
        <div class="row">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <form method="POST" action="{{ route('wilayah.update', $data->id) }}">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        <div class="form-body">
                            @if ($errors->any())
                            ...
                            <div class="form-group">
                                    ...
                                    <input name="dusun" required type="text" class="form-control m-input" placeholder="Nama Dusun" value="{{ $data->dusun }}">
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
  let $photoInput = $('[name="photo"]'),
    ...
    coordinates = {!! (old('coordinates') ?: $data->coordinate ?: '[]') !!},
