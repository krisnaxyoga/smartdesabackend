...
<div class="content-main" id="content-main">
    <div class="padding">
        ...
        <div class="row">
                ...
                <div class="col-md-12">
                    <form action="{{route('bantuan.peserta.update',[$data->id,$peserta->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                    <div class="box">
                        ...
                        <div class="box-body"> 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select required  class="form-control" name="peserta_id">
                                            <option value="{{$peserta->peserta}}">{{$peserta->penduduk->nama}} [{{$peserta->penduduk->nik}}] - {{$peserta->penduduk->dusun->dusun}}</option>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text" value="{{$peserta->penduduk->alamat_sekarang}}" class="form-control"  readonly name="alamat_keluarga">
                                    </div>
                                    <div class="form-group ">
                                        <label for="">Tempat Tanggal Lahir (Umur) KK</label>
                                        <input type="text" value="{{$peserta->penduduk->tempatlahir}}, {{$peserta->penduduk->konversiTgl($peserta->penduduk->tanggallahir)}}" class="form-control" readonly name="ttl">
                                    </div>
                                    <div class="form-group ">
                                        <label for="">Pendidikan KK</label>
                                        <input type="text" value="{{$peserta->penduduk->pendidikanKK->nama}}" class="form-control" readonly name="pendidikan_kk">
                                    </div>
                                    <div class="form-group ">
                                        <label for="">Warganegara / Agama KK</label>
                                        <input type="text" value="{{$peserta->penduduk->kewarganegaraan->nama}}" class="form-control" readonly name="agama">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Nomor Kartu Peserta</label>
                                        <input type="text" value="{{$peserta->no_id_kartu}}" class="form-control" name="no_id_kartu" required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="">NIK</label>
                                        <input type="text" class="form-control" value="{{$peserta->kartu_nik}}" name="kartu_nik" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Nama</label>
                                        <input type="text" class="form-control" value="{{$peserta->kartu_nama}}" name="kartu_nama" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Tempat Lahir</label>
                                        <input type="text" class="form-control"  value="{{$peserta->kartu_tempat_lahir}}" name="kartu_tempat_lahir" required>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                                ...
                                                <input type="text"  value="{{$peserta->kartu_tanggal_lahir}}" class="form-control datepicker-input" id="datepicker" data-toggle="datepicker" data-target="#datepicker" autocomplete="off" name="kartu_tanggal_lahir" required>
                                            </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Alamat</label>
                                        <input type="text" class="form-control"  value="{{$peserta->kartu_alamat}}" name="kartu_alamat" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box-footer">
                                <a href="{{ url('bantuan/'.$data->id) }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> Kembali</a>
