    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="box">
          ...
          <form id="line-form" class="form-horizontal" action="/peta/garis" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
              <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="col-lg-9">
                      <select name="tipe_garis_id" class="form-control">
                        ...
                        @foreach ($types as $type)
                          <option value="{{ $type->id }}" {{ old('tipe_garis_id') == $type->id ? 'selected' : '' }}>{{ $type->name }}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
