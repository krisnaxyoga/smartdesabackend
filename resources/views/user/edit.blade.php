        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="box">
                    ...
                    <form method="POST" class="form-horizontal" action="/user/{{ $data->id }}">
                        @csrf
                        @method('PUT')
                        <div class="box-body">
                            @if ($errors->any())
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col">
                                        <input name="username" type="text" class="form-control m-input" placeholder="Username" value="{{ old('username') ?: $data->username }}">
                                    </div>
                                </div>
                                <div class="form-group row">
