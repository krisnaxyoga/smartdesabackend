                    ...
                    <div class="box-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label>Judul</label>
                                    <input name="judul" value="{{$data == null || $data->judul == null ? 'Sejarah' : $data->judul}}" required type="text" class="form-control m-input" placeholder="Judul">
                                </div>
                                <div class="form-group">
                                    <label>Isi</label>
                    ...
                    <div class="box">
                        ...
                        <div class="box-footer">
                            ...
                            @if($data == null || $data->gambar != null)
                                <a href="{{route('remove-img',['SEJARAH'])}}"  class="btn btn-danger" style="display : block;width : 100%;margin-top : 10px"><i class="fa fa-trash"></i> Remove Featured Image</a>    
                            @endif
                        </div>
                    </div>
            </div>
