...
<div class="content-main" id="content-main">
    <div class="padding">
        <form method="POST" action="{{ url('berita/'.$data->id) }}" enctype="multipart/form-data">
            @method('PUT')
            <div class="row">
            <div class="col-md-9">
                <div class="box">
                    ...
                    <div class="box">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <select name="kategori_artikel_id" id="" class="form-control" required>
                                        ...
                                        @foreach($kategori as $item)
                                            <option value="{{$item->id}}" {{$item->id == $data->kategori_artikel_id? 'selected' : ''}}>{{$item->nama}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                        <div class="checkbox">
                                            <label class="ui-check">
                                                <input type="checkbox" {{$data->show_slider == '1' ? 'checked' : ''}} name="show_slider"> <i class="dark-white"></i> Tampilkan Pada Slider
                                            </label>
                                        </div>
                                </div>
                            </div>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="preview-img">
                                <img src="{{$data->gambar === null ? "asset('images/sample_image.png')" : $data->gambar}}" alt="" class="dummy-avatar" id="dummy">
                            </div>
                        </div>
