...
<div class="content-main" id="content-main">
    <div class="padding">
        <form method="POST" action="{{ url('slider/'.$data->id) }}" enctype="multipart/form-data">
            @method('PUT')
            <div class="row">
            <div class="col-md-9">
                <div class="box">
                    ...
                    <div class="box-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label>Title</label>
                                    <input name="title" required type="text" class="form-control m-input" placeholder="Title" value="{{ $data->title }}">
                                </div>
