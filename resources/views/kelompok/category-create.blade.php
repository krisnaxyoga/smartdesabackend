            ...
            <div class="col-md-6">
                <div class="box">
                        ...
                        <form method="POST" action="{{ route('kategori-kelompok.store') }}">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="kelompok" required type="text" class="form-control m-input" placeholder="Nama Kelompok" value="{{ old('nama') }}">
                                </div>
                    ...
                    <div class="box-footer">
                        <a href="{{ url('kelompok') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> Kembali</a>
