...
<div class="content-main" id="content-main">
    <div class="padding">
        ...
        <div class="row">
                ...
                <div class="col-md-6">
                    <form action="{{route('kelompok.anggota.store',[$data->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="box">
                        <div class="box-header">
                            <div class="pull-left">
                                <h3 style="display : inline;padding : .25rem .5rem">Tambah Anggota Kelompok {{$data->nama}}</h3>
                                </div>
...
<script type="text/javascript">
    ...
    $('select[name=penduduk_id]').select2({
        ...
        width : "100%",
        ajax: {
            url: '{{route("api.pendudukTanpaKelompok",[$data->id])}}',
