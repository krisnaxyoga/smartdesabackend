    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="box">
          ...
          <form class="form-horizontal" action="/cctv" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="lat" value="{{ old('lat') ?: -8.644609 }}" />
            <input type="hidden" name="lng" value="{{ old('lng') ?: 115.2046587 }}" />
            <div class="box-body">
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="nama_cctv" class="form-control" value="{{ old('name') }}" />
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-form-label col-lg-3">Link CCTV</label>
                    <div class="col-lg-9">
                      <input type="text" name="link" class="form-control" value="{{ old('name') }}" />
                    </div>
                  </div>
                  <div class="form-group row">
...
<script type="text/javascript">
  let mapContainer = document.getElementById('map'),
    ...
    lat = {{ old('lat') ?: -8.644609 }},
    lng = {{ old('lng') ?: 115.2046587 }},
    map, marker
