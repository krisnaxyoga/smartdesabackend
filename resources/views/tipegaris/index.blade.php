...
@section('action')
  <a href="/peta/tipegaris/create" class="btn btn-rounded btn-success"><i class="fa fa-plus"></i> Tambah Tipe Garis</a>
@endsection
...
<script type="text/javascript">
  let dataTable = $("#datatable").DataTable({
    ajax: "/peta/tipegaris?type=datatable",
    processing: true,
    serverSide : true,
    order: [[ 1, "asc" ]],
    columns: [
