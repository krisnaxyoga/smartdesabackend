  ...
  <div class="padding">
    <div class="row">
      <div class="col-lg-6">
        ...
        @endif
        <div class="box">
          <div class="box-header"><h3>Form Tipe Garis</h3></div>
          <div class="box-divider m-0"></div>
          <form class="form-horizontal" action="/peta/tipegaris/{{ $data->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="box-body">
              <div class="form-group row">
                <label class="col-form-label col-lg-3">Nama Tipe Garis</label>
                <div class="col-lg-9">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <input type="text" name="color" required class="jscolor" value="{{ old('color') ?: $data->color }}" />
                </div>
              </div>
              <div class="form-group row">
            ...
            <div class="box-footer">
              ...
              <a href="/peta/tipegaris" class="btn btn-rounded btn-default">Batal</a>
            </div>
          </form>
        </div>
      </div>
