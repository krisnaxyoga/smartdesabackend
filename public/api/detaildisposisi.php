...
$select = "SELECT * FROM `pengaduans` INNER JOIN `pengaduan_comments` ON pengaduan_comments.pengaduan_id = pengaduans.id WHERE `penduduk_id` = '$penduduk_id' AND `status` = 'DONE'";
