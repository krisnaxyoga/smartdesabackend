...
function(t, e) {
    ...
    return function(t) {
        ...
        const Oo = Symbol("observableProperties"),
            Ro = Symbol("boundObservables"),
            Do = Symbol("boundProperties"),
            Lo = {
                set(t, e) {
        ...
        function Vo(t) {
            Oo in t || (Object.defineProperty(t, Oo, {
                value: new Map
        ...
        class $o {
            ...
            getShiftedBy(t) {
                const e = $o.createFromPosition(this),
                    n = e.offset + t;
        ...
        class Qo {
            ...
            getEnlarged() {
                let t = this.start.getLastMatchingPosition(Jo, {
                    ...
                    e = this.end.getLastMatchingPosition(Jo);
            ...
            getTrimmed() {
                ...
                let e = this.end.getLastMatchingPosition(Jo, {
                    direction: "backward"
                });
                const n = t.nodeAfter,
                    o = e.nodeBefore;
        ...
        class Zo {
            ...
            setTo(t, e, n) {
                ...
                else if (t instanceof Zo || t instanceof Xo) this._setRanges(t.getRanges(), t.isBackward), this._setFakeOptions({
                    fake: t.isFake,
                    label: t.fakeSelectionLabel
                });
                else if (t instanceof Qo) this._setRanges([t], e && e.backward), this._setFakeOptions(e);
                else if (t instanceof $o) this._setRanges([new Qo(t)]), this._setFakeOptions(e);
        ...
        class ei {
            constructor() {
                this.selection = new Xo, this.roots = new ti({
                    idProperty: "rootName"
        ...
        function fi(t) {
            let e;
            if ("string" == typeof t) {
                if (!(e = hi[t.toLowerCase()])) throw new M.b("keyboard-unknown-key: Unknown key name.", {
                    key: t
                })
        ...
        class ki {
            ...
            breakContainer(t) {
                ...
                if (!t.isAtEnd) {
                    ...
                    const o = new Qo(t, $o.createAt(e, "end")),
                        i = new $o(n, 0);
                    this.move(o, i)
                }
            ...
            mergeContainers(t) {
                ...
                const o = e.getChild(e.childCount - 1),
                    i = o instanceof co ? $o.createAt(o, "end") : $o.createAt(e, "end");
            ...
            clear(t, e) {
                ...
                for (const o of n) {
                    const n = o.item;
                    let i;
                    if (n.is("element") && e.isSimilar(n)) i = Qo.createOn(n);
            ...
            _wrapRange(t, e) {
                if (function(t) {
                    ...
                    const e = t.start.parent,
                        n = this.mergeAttributes($o.createAfter(e)),
                        o = this.mergeAttributes($o.createBefore(e));
                    return new Qo(o, n)
                }
                const {
                    start: n,
        ...
        const Ii = t => {
            ...
            Ni = t => t.createTextNode("Â "),
            Oi = 7;
        let Ri = "";
        for (let t = 0; t < Oi; t++) Ri += "â€‹";
        ...
        class er {
            ...
            domToView(t, e = {}) {
                ...
                if (this.isComment(t)) return null; {
                    ...
                    let n;
                    if (this.isDocumentFragment(t)) n = new _i, e.bind && this.bindDocumentFragments(t, n);
                    else {
            ...
            domPositionToView(t, e) {
                ...
                if (0 === e) {
                    ...
                    const n = t.childNodes[e - 1],
                        o = Ei(n) ? this.findCorrespondingViewText(n) : this.mapDomToView(n);
            ...
            _processDataFromDomText(t) {
                ...
                return i && (e = e.replace(/^ /, "")), r && (e = e.replace(/ $/, "")), e = (e = ji(new Text(e))).replace(/ \u00A0/g, "  "), i && (e = e.replace(/^\u00A0/, " ")), Ei(o) && "Â " != o.data.charAt(0) || (e = e.replace(/\u00A0( *)$/, " $1")), e
            }
            ...
            _getTouchingInlineDomNode(t, e) {
                ...
                const n = e ? "nextNode" : "previousNode",
                    ...
                    r = o.createTreeWalker(i, NodeFilter.SHOW_TEXT | NodeFilter.SHOW_ELEMENT, {
                        acceptNode: t => Ei(t) ? NodeFilter.FILTER_ACCEPT : "BR" == t.tagName ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP
                    });
                r.currentNode = t;
                const s = r[n]();
                if (null !== s) {
        ...
        class ks {
            ...
            excludeScrollbarsAndBorders() {
                const t = this._source;
                let e, n;
                if (ir(t)) e = t.innerWidth - t.document.documentElement.clientWidth, n = t.innerHeight - t.document.documentElement.clientHeight;
                else {
        ...
        class Vs {
            ...
            _insertNodes(t, e) {
                for (const t of e)
                    if (!(t instanceof Ds)) throw new M.b("model-nodelist-insertNodes-not-node: Trying to insert an object which is not a Node instance.");
        ...
        class zs {
            ...
            _next() {
                const t = this.position,
                    e = Hs.createFromPosition(this.position),
        ...
        class Hs {
            ...
            getShiftedBy(t) {
                const e = Hs.createFromPosition(this),
                    n = e.offset + t;
                return e.offset = n < 0 ? 0 : n, e
            }
            isAfter(t) {
        ...
        class qs {
            ...
            getMinimalFlatRanges() {
                const t = [],
                    ...
                    n = Hs.createFromPosition(this.start);
                let o = n.parent;
            ...
            _getTransformedByMove(t, e, n, o = !1) {
                ...
                const i = qs.createFromPositionAndShift(t, n),
            ...
            static createFromRanges(t) {
                ...
                if (n > 0)
                    for (let e = n - 1; t[e].end.isEqual(o.start); e++) o.start = Hs.createFromPosition(t[e].start);
            ...
            convertInsert(t, e) {
                ...
                for (const e of t) {
                    const t = e.item,
                        n = {
                            item: t,
                            range: qs.createFromPositionAndShift(e.previousPosition, e.length)
                        };
        ...
        class Js {
            ...
            setTo(t, e, n) {
                if (null === t) this._setRanges([]);
                    ...
                    const o = !!n && !!n.backward;
                    let i;
                    if ("in" == e) i = qs.createIn(t);
                    else if ("on" == e) i = qs.createOn(t);
                    else {
            ...
            setFocus(t, e) {
                ...
                if ("same" == n.compareWith(this.focus)) return;
                const o = this.anchor;
                this._ranges.length && this._popRange(), "before" == n.compareWith(o) ? (this._pushRange(new qs(n, o)), this._lastRangeBackward = !0) : (this._pushRange(new qs(o, n)), this._lastRangeBackward = !1), this.fire("change:range", {
                    directChange: !0
                })
            }
            getAttribute(t) {
            ...
            _checkRange(t) {
                for (let e = 0; e < this._ranges.length; e++)
                    if (t.isIntersecting(this._ranges[e])) throw new M.b("model-selection-range-intersects: Trying to add a range that intersects with another range in the selection.", {
                        addedRange: t,
                    ...
                    function() {
                        this.listenTo(this.root.document.model, "applyOperation", (t, e) => {
                            ...
                            n.isDocumentOperation && function(t) {
                                ...
                                } else i && this.fire("change:content", qs.createFromRange(this), {
                                    deletionPosition: r
                                })
                            }.call(this, n)
                        }, {
        ...
        class na extends Js {
            ...
            _fixGraveyardSelection(t, e) {
                const n = Hs.createFromPosition(e),
        ...
        function da(t, e) {
            return "function" == typeof t ? t : (n, o) => (function(t, e, n) {
                ...
                if ("container" == n) o = e.createContainerElement(t.name, i);
                    ...
                    const n = {
                        priority: t.priority || oi.DEFAULT_PRIORITY
                    };
        ...
        class fa {
            constructor(t) {
                this.model = t, this.view = new Os, this.mapper = new Ws, this.downcastDispatcher = new $s({
                    mapper: this.mapper
                });
        ...
        class ka {
            ...
            checkAttributeInSelection(t, e) {
                ...
                for (const i of t.getItems({
                        shallow: !0
                    })) i.is("element") && (yield* this._getValidRangesForRange(qs.createIn(i), e)), this.checkAttribute(i, e) || (n.isEqual(o) || (yield new qs(n, o)), n = Hs.createAfter(i)), o = Hs.createAfter(i);
        ...
        class va {
            constructor(t) {
                ...
                "string" == typeof t ? t = [t] : Array.isArray(t) || (t = t.getAncestors({
                    includeSelf: !0
                })), t[0] && "string" != typeof t[0] && t[0].is("documentFragment") && t.shift(), this._items = t.map(Ia)
            }
            get length() {
                return this._items.length
            }
        ...
        class Fa {
            constructor(t, e) {
                this.model = t, this.processor = e, this.mapper = new Ws, this.downcastDispatcher = new $s({
                    mapper: this.mapper
        ...
        class za {
            ...
            elementToElement(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of Ba(t)) this.for("upcast").add(Oa({
                    model: e,
                    view: n,
            ...
            attributeToElement(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of Ba(t)) this.for("upcast").add(Ra({
                    view: n,
                    model: e,
                    priority: t.priority
                }))
            ...
            attributeToAttribute(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of Ba(t)) this.for("upcast").add(Da({
                    view: n,
                    model: e
                }))
            }
        ...
        function Ka(t) {
            ...
            if (e) {
                ...
                const r = new Ls(e.data.substr(0, o), e.getAttributes()),
        ...
        class nc extends qa {
            ...
            static fromJSON(t, e) {
                const n = Hs.fromJSON(t.sourcePosition, e),
                    o = Hs.fromJSON(t.targetPosition, e);
        ...
        class oc extends qa {
            ...
            clone() {
                const t = new Vs([...this.nodes].map(t => t._clone(!0))),
                    e = new oc(this.position, t, this.baseVersion);
        ...
        class ac extends qa {
            ...
            getReversed() {
                const t = this.targetPosition._getTransformedByMergeOperation(this),
                    ...
                    o = new cc(t, this.howMany, this.graveyardPosition, this.baseVersion + 1);
            ...
            static fromJSON(t, e) {
                const n = Hs.fromJSON(t.sourcePosition, e),
                    o = Hs.fromJSON(t.targetPosition, e),
                    i = Hs.fromJSON(t.graveyardPosition, e);
        ...
        class cc extends qa {
            ...
            _execute() {
                const t = this.splitPosition.parent;
                if (this.graveyardPosition) $a(qs.createFromPositionAndShift(this.graveyardPosition, 1), this.insertionPosition);
                else {
                    const e = t._clone();
            ...
            static fromJSON(t, e) {
                const n = Hs.fromJSON(t.splitPosition, e),
                    o = Hs.fromJSON(t.insertionPosition, e),
                    i = t.graveyardPosition ? Hs.fromJSON(t.graveyardPosition, e) : null,
        ...
        class dc {
            ...
            insert(t, e, n) {
                ...
                if (t instanceof Ls && (r.shouldReceiveAttributes = !0), this.batch.addOperation(r), this.model.applyOperation(r), t instanceof Wa)
                    for (const [e, n] of t.markers) {
                        const t = Hs.createAt(n.root),
                            i = new qs(n.start._getCombined(t, o), n.end._getCombined(t, o));
                        this.addMarker(e, {
                            range: i,
                            usingOperation: !0
                        })
            ...
            move(t, e, n) {
                ...
                const i = t.root.document ? t.root.document.version : null,
                    r = new nc(t.start, t.end.offset - t.start.offset, o, i);
            ...
            _merge(t) {
                const e = Hs.createAt(t.nodeBefore, "end"),
                    n = Hs.createAt(t.nodeAfter, 0),
                    o = t.root.document.graveyard,
                    i = new Hs(o, [0]),
                    r = t.root.document.version,
                    s = new ac(n, t.nodeAfter.maxOffset, e, i, r);
            ...
            rename(t, e) {
                ...
                const n = t.root.document ? t.root.document.version : null,
                    o = new rc(Hs.createBefore(t), t.name, e, n);
            ...
            split(t, e) {
                ...
                return {
                    position: t,
                    range: new qs(Hs.createAt(n, "end"), Hs.createAt(o))
                }
            }
            wrap(t, e) {
        ...
        function fc(t, e, n, o, i) {
            const r = t.model,
                s = r.document,
                a = new ic(e, n, o, r.markers, i, s.version);
                ...
                for (const t of this._changesInElement.keys()) {
                    ...
                    for (const n of r)
                        ...
                        const n = i[s].attributes,
                            r = o[a].attributes;
                        let c;
                        if ("$text" == i[s].name) c = qs.createFromParentsAndOffsets(t, s, t, s + 1);
                        else {
        ...
        class Ac {
            constructor(t) {
                this.model = t, this.version = 0, this.history = new kc(this), this.selection = new ea(this), this.roots = new ti({
                    idProperty: "rootName"
        ...
        class Tc {
            ...
            _set(t, e, n = !1, o = !1) {
                const i = t instanceof Mc ? t.name : t,
                ...
                const s = Xs.createFromRange(e),
                    a = new Mc(i, s, n, o);
                return this._markers.set(i, a), this.fire("update:" + i, a, null, e), a
            }
            _remove(t) {
                const e = t instanceof Mc ? t.name : t,
        ...
        class Sc {
            ...
            _checkAndSplitToAllowedPosition(t) {
                ...
                for (; e != this.position.parent;) {
                    ...
                    } else if (this.position.isAtEnd) this.position = Hs.createAfter(this.position.parent);
                    else {
        ...
        function Ec(t, e, n = {}) {
            ...
            t.change(t => {
                ...
                s.stickiness = "toNext", i.start.isTouching(i.end) || t.remove(i), n.leaveUnmerged || (! function t(e, n, o) {
                        ...
                        t(e, n, o)
                    }(t, r, s), o.removeDisallowedAttributes(r.parent.getChildren(), t)), e instanceof ea ? t.setSelection(r) : e.setTo(r),
                    function(t, e) {
        ...
        function Fc(t, e) {
            return t.isCollapsed ? function(t, e) {
                ...
                if (c || l) {
                    const t = c ? zc(Hs.createAt(s), e, "start") : n,
                        i = l ? zc(Hs.createAt(a), e, "end") : o;
                    return new qs(t, i)
                }
                return null
            }(t, e)
            ...
            getSelectedContent(t) {
                return function(t, e) {
                    return t.change(t => {
                        ...
                        if (a != o) {
                            const e = o._getTransformedByMove(a.start, Hs.createAt(n, 0), c)[0],
                                i = new qs(Hs.createAt(n), e.start);
        ...
        class qc {
            constructor(t) {
                ...
                this.config = new T(t, this.constructor.defaultConfig), this.config.define("plugins", e), this.plugins = new ma(this, e), this.commands = new pa, this.locale = new ba(this.config.get("language")), this.t = this.locale.t, this.set("state", "initializing"), this.once("ready", () => this.state = "ready", {
                    ...
                    priority: "high"
                }), this.set("isReadOnly", !1), this.model = new Bc, this.data = new Fa(this.model), this.editing = new fa(this.model), this.editing.view.document.bind("isReadOnly").to(this), this.conversion = new za, this.conversion.register("downcast", [this.editing.downcastDispatcher, this.data.downcastDispatcher]), this.conversion.register("editingDowncast", [this.editing.downcastDispatcher]), this.conversion.register("dataDowncast", [this.data.downcastDispatcher]), this.conversion.register("upcast", [this.data.upcastDispatcher]), this.keystrokes = new Hc(this), this.keystrokes.listenTo(this.editing.view.document)
            }
            initPlugins() {
                const t = this,
                    e = this.config;
        ...
        class rl {
            ...
            _renderAttributes(t) {
                ...
                for (e in this.attributes)
                    if (o = r.getAttribute(e), n = this.attributes[e], s && (s.attributes[e] = o), i = ot(n[0]) && n[0].ns ? n[0].ns : null, ll(n)) {
                        const a = i ? n[0].value : n;
                        s && yl(e) && a.unshift(o), this._bindToObservable({
                            schema: a,
                            updater: ul(r, e, i),
                            data: t
                        })
            ...
            _renderElementChildren(t) {
                ...
                for (const r of this.children)
                    ...
                    } else if (_l(r)) o || (r.isRendered || r.render(), n.appendChild(r.element));
                else if (qi(r)) n.appendChild(r);
                else if (o) {
                    const e = {
                        children: [],
                        bindings: [],
            ...
            if ("string" == typeof t ? t = function(t) {
                ...
                if (t.children)
                    if (vl(t.children)) e.push(t.children);
                        ...
                        for (const n of t.children) kl(n) || _l(n) || qi(n) ? e.push(n) : e.push(new rl(n));
                t.children = e
            }
            return t
        }
        ...
        class Vl extends qc {
            constructor(t, e) {
                super(e), tr(t) && (this.sourceElement = t), this._elementReplacer = new jl, this.data.processor = new $c, this.model.document.createRoot(), this.ui = new Xc(this, new Ll(this.locale)),
                    function(t) {
        ...
        class Bl extends Jr {
            ...
            onDomEvent(t) {
                const e = {
                    dataTransfer: new zl(t.clipboardData ? t.clipboardData : t.dataTransfer)
                };
                ...
                t.change(n => {
                    ! function(t, e, n, o) {
                        ...
                        if (i) Gl(e, n, r.start);
                            ...
                            t.deleteContent(n, {
                                leaveUnmerged: o
                            }), o && (i ? Gl(e, n, n.focus) : e.setSelection(a, 0))
                        }
                ...
                t.change(n => {
                    ! function(t, e, n) {
                        ...
                        if (o) Kl(e, i.end);
                            ...
                            t.deleteContent(n, {
                                leaveUnmerged: o
                            }), a ? Kl(e, n.focus) : o && e.setSelection(s, 0)
                        }
        ...
        class ad {
            ...
            handle(t, e) {
                if (id(t)) this._handleContainerChildrenMutations(t, e);
                else
            ...
            _handleContainerChildrenMutations(t, e) {
                ...
                const w = u.substr(m, p),
                    _ = qs.createFromParentsAndOffsets(s, m, s, m + g);
            ...
            _handleTextMutation(t, e) {
                ...
                const c = new $o(t.node, i),
                    l = this.editing.mapper.toModelPosition(c),
                    d = qs.createFromPositionAndShift(l, s),
                    u = n.substr(i, r);
                this.editor.execute("input", {
                    text: u,
                    range: d,
        ...
        class hd extends cr {
            constructor(t) {
                ...
                e.on("keyup", (t, e) => {
                    ...
                    const i = {};
                    if (o.keyCode == hi.delete) i.direction = "forward", i.unit = "character";
                    else {
                    ...
                    i.unit = r ? "word" : i.unit, i.sequence = ++n, e.once("delete", t => s = t, {
                        priority: "highest"
                    }), e.fire("delete", new Qr(e, o.domEvent, i)), s && s.stop.called && t.stop()
                })
            }
            observe() {}
        }
        ...
        function yd(t, e, n) {
            ...
            return Ad(t, i.nextBaseVersionB), Ad(e, i.nextBaseVersionA), {
                operationsA: t,
                operationsB: e
            }
        }
        ...
        function Pd(t, e) {
            ...
            for (let o = 0; o < t.length; o++) {
                const i = t[o],
                    r = new nc(i.start, i.end.offset - i.start.offset, e, 0);
                n.push(r);
        ...
        _d(tc, tc, (t, e, n) => {
            if (t.key === e.key) {
                const o = t.range.getDifference(e.range).map(e => new tc(e, t.key, t.oldValue, t.newValue, 0)),
            ...
            const o = qs.createFromPositionAndShift(t.sourcePosition, t.howMany),
                i = qs.createFromPositionAndShift(e.sourcePosition, e.howMany);
            let r, s = n.aIsStrong,
                a = !n.aIsStrong;
            ...
            if (!t.graveyardPosition && !n.bWasUndone && t.splitPosition.hasSameParentAs(e.sourcePosition)) {
                const n = e.graveyardPosition.path.slice();
                n.push(0);
                const o = new Hs(e.graveyardPosition.root, n),
                    i = cc.getInsertionPosition(new Hs(e.graveyardPosition.root, n)),
                    r = new cc(o, 0, null, 0);
        ...
        class Hd extends Fl {
            ...
            init() {
                this.set("hasAny", !1), this._actions = new ti({
                    idProperty: "_id"
        ...
        class pu extends ql {
            ...
            execute() {
                ...
                t.change(t => {
                    if (this.value) this._removeQuote(t, o.filter(gu));
                    else {
                    ...
                    for (const t of o)
                        if ("insert" == t.type) {
                            ...
                            if (o.is("element")) {
                                ...
                                for (const o of t.getItems())
                                    if (o.is("blockQuote") && !e.checkChild(Hs.createBefore(o), o)) return n.unwrap(o), !0
                            }
        ...
        class Ru {
            ...
            add(t, e) {
                ...
                const i = n[0];
                o === i || Du(o, i) || this.fire("change:top", {
                    oldDescriptor: o,
                    newDescriptor: i,
                    writer: e
                })
        ...
        var Vu = n(25),
            Fu = n.n(Vu);
        const zu = Symbol("isWidget"),
            Bu = Symbol("label"),
            Uu = "ck-widget",
            Hu = "ck-widget_selected";
        ...
        class oh extends Fl {
            ...
            init() {
                ...
                this._previouslySelected = new Set, this.editor.editing.downcastDispatcher.on("selection", (t, e, n) => {
                    ...
                    priority: "low"
                }), t.addObserver(eh), this.listenTo(e, "mousedown", (...t) => this._onMousedown(...t)), this.listenTo(e, "keydown", (...t) => this._onKeydown(...t), {
                    priority: "high"
            ...
            _onKeydown(t, e) {
                const n = e.keyCode,
                    o = n == hi.delete || n == hi.arrowdown || n == hi.arrowright;
                let i = !1;
                ! function(t) {
                    return t == hi.arrowright || t == hi.arrowleft || t == hi.arrowup || t == hi.arrowdown
                }(n) ? ! function(t) {
        ...
        class mh extends xl {
            ...
            render() {
                super.render(), this.keystrokes.listenTo(this.element), lh({
                    view: this
        ...
        _h.arrowHorizontalOffset = 25, _h.arrowVerticalOffset = 10, _h._getOptimalPosition = function({
            element: t,
            target: e,
            positions: n,
            limiter: o,
            ...
            let c, l;
            if (o || i) {
                const t = o && new ks(o).getVisible(),
                    e = i && new ks(Ki.window);
        ...
        const Fh = Symbol("progress-bar"),
            zh = Symbol("placeholder");
            ...
            refresh() {
                ...
                this.isEnabled = function(t, e) {
                    ...
                    const n = t.getSelectedElement(),
                        o = !!n && e.isObject(n),
                        i = !![...t.focus.getAncestors()].find(t => e.isObject(t));
                    return !o && !i
                }(e, n)
            }
            execute(t) {
        ...
        function Gh(t, e, n) {
            const o = e.model.document,
                i = e.plugins.get(Wd).createLoader(n);
            if (!i) return;
            const r = t.createElement("image", {
                    uploadId: i.id
                }),
                s = $u(o.selection);
        ...
        class Qh extends Fl {
            ...
            init() {
                ...
                }), t.commands.add("imageUpload", new Yh(t)), this.listenTo(t.editing.view.document, "clipboardInput", (e, n) => {
                    if (function(t) {
                            return Array.from(t.types).includes("text/html") && "" !== t.getData("text/html")
                        }(n.dataTransfer)) return;
                    const o = Array.from(n.dataTransfer.files).filter(Rh),
                        i = new Js(n.targetRanges.map(e => t.editing.mapper.toModelRange(e)));
                    t.model.change(n => {
        ...
        class Xh extends Fl {
            ...
            init() {
                const t = this.editor,
                    e = t.model,
                    n = t.data;
                t.commands.add("paragraph", new Kh(t)), e.schema.register("paragraph", {
                    ...
                    if (n.consumable.test(e.viewItem, {
                        ...
                        if (Xh.paragraphLikeElements.has(e.viewItem.name)) {
                            ...
                            const {
                                modelRange: i
                            } = n.convertChildren(e.viewItem, Hs.createAt(t));
        ...
        class sf extends Fl {
            ...
            init() {
                const t = this.editor,
                    ...
                    n = [];
                for (const o of e) o.model !== rf && (t.model.schema.register(o.model, {
                    inheritAllFrom: "$block"
        ...
        class hf extends Ld {
            ...
            _createArrowView() {
                const t = new Rd;
                return t.content = uf.a, t.extendTemplate({
                    attributes: {
        ...
        function bf(t, e = hf) {
            const n = new e(t),
                o = new cf(t),
                i = new lf(t, n, o);
            return n.bind("isEnabled").to(i), n instanceof hf ? n.bind("isOn").to(i, "isOpen") : n.arrowView.bind("isOn").to(i, "isOpen"),
                function(t) {
                    (function(t) {
                        t.on("render", () => {
                            sh({
        ...
        function Af(t) {
            for (const e of t.getChildren())
                if (e instanceof Fs && "caption" == e.name) return e;
            return null
        }
        ...
        class Tf extends Fl {
            init() {
                ...
                i.downcastDispatcher.on("insert:caption", Mf(s)), i.downcastDispatcher.on("insert", this._fixCaptionVisibility(t => t.item), {
                    priority: "high"
        ...
        function qf(t) {
            if ("string" == typeof t) {
                const e = t;
                Bf[e] ? t = Object.assign({}, Bf[e]) : (fs.a.warn("image-style-not-found: There is no such image style of given name.", {
                    name: e
                }), t = {
                    name: e
                })
        ...
        class Wf extends Fl {
            ...
            init() {
                ...
                const r = function(t) {
                    return (e, n, o) => {
                        if (!o.consumable.consume(n.item, e.name)) return;
                        const i = Nf(n.attributeNewValue, t),
                            r = Nf(n.attributeOldValue, t),
                ...
                o.downcastDispatcher.on("attribute:imageStyle:image", r), n.downcastDispatcher.on("attribute:imageStyle:image", r), n.upcastDispatcher.on("element:figure", function(t) {
                    ...
                    priority: "low"
                }), t.commands.add("imageStyle", new If(t, i))
            }
        }
        n(96);
        class Yf extends Fl {
        ...
        class Gf extends Fl {
            ...
            register(t, {
                ...
                const i = this.editor,
                    r = new Dl;
                if (this._toolbars.has(t)) throw new M.b("widget-toolbar-duplicated: Toolbar with the given id was already added.", {
                    toolbarId: t
                });
        ...
        const Xf = Symbol("linkElement"),
            tm = /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g,
            em = /^(?:(?:https?|ftps?|mailto):|[^a-z]|[a-z+.-]+(?:[^a-z+.:-]|$))/i;
        ...
        class um extends Fl {
            init() {
                ...
                t.model.schema.extend("$text", {
                    ...
                    })), t.commands.add("link", new Kf(t)), t.commands.add("unlink", new Zf(t)),
                    function(t, e, n, o) {
                        const i = new im(e, n, o),
                            r = e.document.selection;
                        n.listenTo(t.document, "keydown", (t, e) => {
                            if (!r.isCollapsed) return;
                            if (e.shiftKey || e.altKey || e.ctrlKey) return;
                            const n = e.keyCode == hi.arrowright,
                                o = e.keyCode == hi.arrowleft;
                            if (!n && !o) return;
            ...
            _setupLinkHighlight() {
                ...
                e.document.registerPostFixer(e => {
                    ...
                    if (o.hasAttribute("linkHref")) {
                        const i = Qf(o.getFirstPosition(), o.getAttribute("linkHref")),
        ...
        class Am extends ql {
            ...
            execute() {
                const t = this.editor.model,
                    e = t.document,
                    n = Array.from(e.selection.getSelectedBlocks()).filter(e => Tm(e, t.schema)),
                    o = !0 === this.value;
                t.change(t => {
                    if (o) {
        ...
        function Bm(t, e) {
            const n = !!e.sameIndent,
                o = !!e.smallerIndent,
                i = t instanceof Fs ? t.getAttribute("listIndent") : e.listIndent;
        ...
        function Hm(t, e, n) {
            ...
            if (s = Wm(s), r.insert(s, o), c && "listItem" == c.name) {
                ...
                for (const t of n)
                    if (t.item.is("li")) {
                        const o = r.breakContainer($o.createBefore(t.item)),
                            i = t.item.parent,
                            s = $o.createAt(e, "end");
        ...
        class Ym extends Fl {
            ...
            init() {
                ...
                })(t.model, e)), n.mapper.registerViewToModelLength("li", Gm), e.mapper.registerViewToModelLength("li", Gm), n.mapper.on("modelToViewPosition", Vm), n.mapper.on("viewToModelPosition", Fm), e.mapper.on("modelToViewPosition", Vm), n.downcastDispatcher.on("insert", Om, {
                    priority: "high"
                }), n.downcastDispatcher.on("insert:listItem", Sm), e.downcastDispatcher.on("insert", Om, {
                    priority: "high"
                }), e.downcastDispatcher.on("insert:listItem", Sm), n.downcastDispatcher.on("attribute:listType:listItem", Im), e.downcastDispatcher.on("attribute:listType:listItem", Im), n.downcastDispatcher.on("attribute:listIndent:listItem", Nm), e.downcastDispatcher.on("attribute:listIndent:listItem", Nm), n.downcastDispatcher.on("remove:listItem", Em), n.downcastDispatcher.on("remove", Rm, {
                    priority: "low"
                }), e.downcastDispatcher.on("remove:listItem", Em), e.downcastDispatcher.on("remove", Rm, {
                    priority: "low"
                }), e.upcastDispatcher.on("element:ul", Lm, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:ol", Lm, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:li", jm, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:li", Dm), t.model.on("insertContent", zm, {
                    priority: "high"
                }), t.commands.add("numberedList", new Am(t, "numbered")), t.commands.add("bulletedList", new Am(t, "bulleted")), t.commands.add("indentList", new Mm(t, "forward")), t.commands.add("outdentList", new Mm(t, "backward"));
        ...
        function Gm(t) {
            ...
            for (const n of t.getChildren())
                if ("ul" == n.name || "ol" == n.name)
                    for (const t of n.getChildren()) e += Gm(t);
            return e
        }
        var $m = n(33),
            Qm = n.n($m),
            ...
            constructor(t, e) {
                const n = e.providers,
                    ...
                    r = n.concat(o).filter(t => {
                        const e = t.name;
                        return e ? !i.has(e) : (fs.a.warn("media-embed-no-provider-name: The configured media provider has no name and cannot be used.", {
                            provider: t
                        }), !1)
                    });
        ...
        class dp extends Fl {
            ...
            init() {
                ...
                t.commands.add("mediaEmbed", new ip(t)), e.register("media", {
                    ...
                    view: (t, e) => {
                        ...
                        return function(t, e, n) {
                            return e.setCustomProperty(tp, !0, t), Wu(t, e, {
                                label: n
                            })
                        }(ep(e, r, o, {
                ...
                })), o.for("editingDowncast").add(Xm(r, {
                    renderForEditingView: !0
                })), o.for("upcast").add(Oa({
                    view: {
                        name: "oembed",
            ...
            init() {
                ...
                this.listenTo(t.plugins.get(Hl), "inputTransformation", () => {
                    const t = e.selection.getFirstRange(),
                        n = Pc.createFromPosition(t.start);
                ...
                t.on("element:table", (t, e, n) => {
                        ...
                        for (const r of Array.from(t.getChildren()))
                            if ("tbody" === r.name || "thead" === r.name || "tfoot" === r.name) {
                                ...
                                for (const t of Array.from(r.getChildren()))
                                    if ("thead" === t.parent.name && t.parent === i) e.headingRows++, n.push(t);
                                    else {
                                        o.push(t);
                                        const n = yp(t);
                    ...
                    if (l) {
                        if (n.writer.insert(c, l.position), n.consumable.consume(o, {
                                name: !0
                            }), i.length) i.forEach(t => n.convertItem(t, Hs.createAt(c, "end")));
                        else {
        ...
        function Pp(t = {}) {
            return e => e.on("insert:table", (e, n, o) => {
                ...
                o.writer.insert($o.createAt(s), a), r && (c = function(t, e) {
                    return e.setCustomProperty(Ap, !0, t), Wu(t, e, {
                ...
                for (const e of l) {
                    const {
                        row: n,
                        cell: r
                    } = e, s = Fp(Vp(n, d), a, o), c = Lp(i.getChild(n), n, s, o);
        ...
        function Ip(t = {}) {
            ...
            return t => t.on("attribute:headingRows:table", (t, n, o) => {
                ...
                const r = Hp(o.mapper.toViewElement(i)),
                ...
                if (a > s) {
                    ...
                    for (const n of t)
                        for (const t of n.getChildren()) Op(t, "th", o, e);
                    Bp("tbody", r, o)
                } else {
                    Up(Array.from(i.getChildren()).filter(({
                        index: t
                    }) => c(t, a - 1, s)).reverse(), Fp("tbody", r, o), o);
                    const t = new xp(i, {
                            startRow: a ? a - 1 : a,
                            endRow: s - 1
                        }),
        ...
        function Rp(t, e, n, o) {
            const {
                cell: i
            } = t, r = jp(t, e), s = n.mapper.toViewElement(i);
        ...
        function Dp(t, e, n, o, i) {
            const r = i && i.asWidget,
                s = jp(t, e),
                a = r ? Gu(o.writer.createEditableElement(s), o.writer) : o.writer.createContainerElement(s),
                c = t.cell,
            ...
            if (o.writer.insert(n, a), l) {
                ...
                if (o.consumable.consume(t, "insert"), i.asWidget) {
                    const n = [...t.getAttributeKeys()].length ? "p" : "span",
                        i = o.writer.createContainerElement(n);
        ...
        class Qp extends ql {
            ...
            execute() {
                const t = this.editor,
                    ...
                    n = t.plugins.get(qp),
                    o = bp("tableCell", e.getFirstPosition()).parent,
                    i = o.parent,
                    r = i.getChildIndex(o),
        ...
        class Jp extends ql {
            ...
            execute() {
                const t = this.editor,
                    e = t.model.document.selection,
                    n = t.plugins.get(qp),
                    o = bp("tableCell", e.getFirstPosition()),
                    i = o.parent.parent,
                    {
                        column: r
                    } = n.getCellLocation(o),
        ...
        class Zp extends ql {
            ...
            execute() {
                const t = this.editor.model,
                    e = bp("tableCell", t.document.selection.getFirstPosition()),
                    n = this.value,
                    o = this.direction;
                t.change(t => {
            ...
            _getMergeableCell() {
                const t = bp("tableCell", this.editor.model.document.selection.getFirstPosition());
                if (!t) return;
                const e = this.editor.plugins.get(qp),
        ...
        class tg extends ql {
            ...
            execute() {
                const t = this.editor.model,
                    e = bp("tableCell", t.document.selection.getFirstPosition()).parent,
                    n = e.parent,
                    o = n.getChildIndex(e),
                    ...
                    for (const {
                        ...
                        if (s.has(o)) {
                            const {
                                cell: i,
                                rowspanToSet: r
                            } = s.get(o), a = l ? Hs.createAfter(l) : Hs.createAt(n.getChild(e));
            ...
            execute() {
                ...
                t.change(t => {
                    ...
                    for (const {
                            ...
                            column: n,
                            colspan: o
                        } of s) n <= a && o > 1 && n + o > a ? wp("colspan", o - 1, e, t) : n === a && t.remove(e)
                })
            }
        }
        class ng extends ql {
        ...
        function fg(t, e) {
            e.view.document.registerPostFixer(n => (function(t, e, n, o) {
                let i = !1;
                const r = function(t) {
                    const e = Array.from(t._renderer.markedAttributes).filter(t => !!t.parent).filter(pg).filter(t => gg(t.parent)),
                        n = Array.from(t._renderer.markedChildren).filter(t => !!t.parent).filter(gg).reduce((t, e) => {
        ...
        class bg extends Fl {
            init() {
                ...
                n.register("table", {
                ...
                }), o.for("upcast").add(kp()), o.for("editingDowncast").add(Pp({
                    asWidget: !0
                })), o.for("dataDowncast").add(Pp()), o.for("upcast").add(Oa({
                    model: "tableRow",
                    view: "tr"
                })), o.for("editingDowncast").add(Sp({
                    asWidget: !0
                })), o.for("dataDowncast").add(Sp()), o.for("downcast").add(t => t.on("remove:tableRow", (t, e, n) => {
                    t.stop();
                    ...
                    priority: "higher"
                })), o.for("upcast").add(vp("td")), o.for("upcast").add(vp("th")), o.for("editingDowncast").add(Ep({
                    asWidget: !0
                })), o.for("dataDowncast").add(Ep()), o.attributeToAttribute({
                    model: "colspan",
                    view: "colspan"
                }), o.attributeToAttribute({
                    model: "rowspan",
                    view: "rowspan"
                }), o.for("editingDowncast").add(Np({
                    asWidget: !0
                })), o.for("dataDowncast").add(Np()), o.for("editingDowncast").add(Ip({
                    asWidget: !0
                })), o.for("dataDowncast").add(Ip()), fg(t.model, t.editing), t.commands.add("insertTable", new $p(t)), t.commands.add("insertTableRowAbove", new Qp(t, {
                    order: "above"
                })), t.commands.add("insertTableRowBelow", new Qp(t, {
                    order: "below"
                })), t.commands.add("insertTableColumnBefore", new Jp(t, {
                    order: "before"
                })), t.commands.add("insertTableColumnAfter", new Jp(t, {
                    order: "after"
                })), t.commands.add("removeTableRow", new tg(t)), t.commands.add("removeTableColumn", new eg(t)), t.commands.add("splitTableCellVertically", new Kp(t, {
                    direction: "vertically"
                })), t.commands.add("splitTableCellHorizontally", new Kp(t, {
                    direction: "horizontally"
                })), t.commands.add("mergeTableCellRight", new Zp(t, {
                    direction: "right"
                })), t.commands.add("mergeTableCellLeft", new Zp(t, {
                    direction: "left"
                })), t.commands.add("mergeTableCellDown", new Zp(t, {
                    direction: "down"
                })), t.commands.add("mergeTableCellUp", new Zp(t, {
                    direction: "up"
                })), t.commands.add("setTableColumnHeader", new ig(t)), t.commands.add("setTableRowHeader", new ng(t)), rg(e), lg(e), this.editor.keystrokes.set("Tab", (...t) => this._handleTabOnSelectedTable(...t), {
                    priority: "low"
            ...
            _getTabHandler(t) {
                ...
                return (n, o) => {
                    ...
                    const d = c === r.childCount - 1,
                        u = a === s.childCount - 1;
                    let h;
                    if (t && u && d && e.plugins.get(qp).insertRows(s, {
                            at: s.childCount
                        }), t && d) {
        ...
        function Sg(t, e, n, o) {
            const i = t.model = new af(t.model),
                {
                    commandName: r,
                    bindIsOn: s
                } = t.model;
        ...
        Eg.builtinPlugins = [class extends Fl {
            ...
            afterInit() {
                const t = this.editor;
                t.plugins.get(Gf).register("image", {
